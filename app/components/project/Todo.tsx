...
//       <h1 className="text-center my-2 text-3xl text-pink-800">todo app</h1>
//       <form
...
//           className="bg-gray-100 rounded p-2 m-2 text-gray-900"
//         />
...
//           <li
//             key={index}
//             className="text-white border list-none border-white rounded p-2 m-2 w-full hover:bg-gray-700 transition-colors duration-300"
//           >
//             {todo}
//           </li>
//         ))}
